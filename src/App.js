      ...
      <section className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:place-items-center lg:py-20">
        ...
        <article className="px-8 pb-10">
          ...
          <h1 className="text-slate-900 mb-10 font-bold text-3xl lg:text-4xl">
            Осенние кроссовки ограниченной серии
          </h1>
          <p className="text-slate-600 mb-10 leading-relaxed">
            Эти низкопрофильные кроссовки - ваш идеальный компаньон в повседневной одежде.
            Благодаря прочной резиновой подошве они выдержат все
            погода может предложить.
          </p>

          <div className="flex flex-wrap items-center justify-between lg:flex-col lg:items-start lg:gap-2">
            <ul className="flex items-center gap-5">
              <li className="text-slate-900 font-bold text-2xl">12500 тг</li>
